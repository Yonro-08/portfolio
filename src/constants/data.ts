...
export const BtnList = [
	{ id: 1, label: 'Home', link: '/', icon: 'home', newTab: false },
	{ id: 2, label: 'About', link: '/about', icon: 'about', newTab: false },
	{
		id: 3,
		label: 'Projects',
		link: '/projects',
	...
	{ id: 4, label: 'Contact', link: '/contact', icon: 'contact', newTab: false },
	{
		id: 5,
		label: 'Github',
